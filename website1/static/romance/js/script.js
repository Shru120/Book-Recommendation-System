  ...
  var products = [
    {
      id: 0,
      name: "Paradise",
      description: "by Judith McNaught",
    ...
    },
    {
      ...
      description: "By Casey McQuiston ",
    ...
    },
    {
      id: 3,
      name: "The Notebook",
      description: "By Nicholas Sparks",
      imageUrl: "./images/notebook.jpg",
      price: 152
    },
    {
      id: 4,
      name: "An Offer From a Gentlemen",
      description: "By Julia Quinn.",
    ...
    },
    {
      id: 5,
      name: "The Proposal",
      description: "By Jasmine Guillory",
  ...
  var generateProductList = function() {
    products.forEach(function(item) {
      ...
      productEl.innerHTML = `<div class="product-image">
                             ...
                             <div class="product-description"><span>Author:</span> ${item.description}</div>
                             <div class="product-price"><span>Price:</span> ${item.price} ₹</div>
                             <div class="product-add-to-cart">
                               <a href="#0" class="button see-more">More Details</a>
                               <a href="#0" class="button add-to-cart" data-id=${item.id}>Wishlist</a>
                             </div>
                          </div>
`;
